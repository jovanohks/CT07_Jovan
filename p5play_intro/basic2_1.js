...
function updatenoun(){
    ...
    storytext = templates.replace("{noun}",nouninput.value()).replace("{noun}",verbinput.value()).replace("{adjetive}",adjinput.value()).replace("{noun}",adverb.value()).replace("{noun}",place.value())                    
    background("220");
    textSize(12);
