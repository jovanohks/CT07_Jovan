...
function updatenoun(){
    ...
    storytext = templates.replace("{noun}",nouninput.value()).replace("{noun}",verbinput.value()).replace("{noun}",adjinput.value()).replace("{noun}",nouninput.value()).replace("{noun}",nouninput.value())                    
    background("220");
    textSize(12);
